...
// import { FiShoppingCart, FiHeart, FiUser, FiMenu, FiX, FiLogIn } from 'react-icons/fi';
...
//   return (
//     <header className="w-full bg-[#393185] text-white top-0 z-10">
//       {/* Top Bar */}
...
//       {/* Main Navbar */}
//       <div className="px-4 sm:px-6 md:px-8 lg:px-10 xl:px-20 py-4 relative">
...
//           {/* Logo */}
//           <Link to="/Home" className="flex items-center justify-center md:justify-start lg:gap-3 md:gap-1">
//             <img src={logo} alt="Logo Icon" className="w-12 h-12 md:w-10 md:h-10" />
//             <img src={logoimg} alt="Logo Text" className="h-8" />
//           </Link>

//           {/* Desktop Navigation */}
//           <nav className="hidden md:flex justify-center items-center gap-4 text-sm md:text-base font-semibold">
...
//             <Link to="/AddCart">
//               <button className="bg-white w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-100">
...
//             <Link to="/Login">
//               <button className="bg-white w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-100">
//                 <FiLogIn className="text-[#393185] w-4 h-4" />
//               </button>
//             </Link>
//           </div>
//         </div>
...
//         {/* Mobile Navigation */}
//         {isMobileMenuOpen && (
//           <nav className="md:hidden flex flex-col w-full bg-[#393185] py-4 space-y-4 items-center">
//             <Link to="/Home" className="text-white hover:text-gray-200">Home</Link>
//             <Link to="/Product" className="text-white hover:text-gray-200">All Product</Link>
//             <Link to="/About" className="text-white hover:text-gray-200">About us</Link>
//             <Link to="/Contact" className="text-white hover:text-gray-200">Contact</Link>
...
//             className="flex items-center justify-center md:justify-start lg:gap-3 md:gap-1"
//           >
